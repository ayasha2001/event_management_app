...
const ViewDetailModal = ({
  ...
  const closeModal = () => {
   ...
   return isOpen && (
    <div className="fixed inset-0 /overflow-y-hidden flex items-center justify-center bg-black bg-opacity-50"> 
    <div className="relative bg-white rounded-lg shadow-lg w-full max-w-lg p-6">
      ...
      <XMarkIcon onClick={closeModal} className='absolute right-4 top-4 h-6 w-6 cursor-pointer hover:opacity-50' />
      </div>
    </div>
  )
}
